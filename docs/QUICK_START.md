...
|----------|--------|-------------------|---------------|
| [openscap](https://github.com/complytime/complytime-providers/tree/main/cmd/openscap-provider) | `complyctl-provider-openscap` | CIS benchmarks (Fedora, RHEL) | `openscap-scanner`, `scap-security-guide` |
